...
function bundleTaskRunner(callback) {
    ...
    Async.parallel(this.tasks, (err, taskResults) => {
        ...
        this.generateManifest(taskResults, (err, manifest) => {
            ...
            // Papathemes MOD
            if (typeof this.options.name === 'string' && this.options.name.match(/trial/i)) {
                this.configuration.trial = true;
            }
...
function bundleThemeFiles(archive, themePath, configuration) {
    ...
    // Papathemes MOD
    var zips = PATHS_TO_ZIP;
    if (typeof configuration.trial !== 'undefined' && configuration.trial) {
        zips.push('!assets/js/**');
        zips.push('!assets/scss/**');
        //zips.push('!assets/scss/components/**');
        //zips.push('!assets/scss/layouts/**');
        //zips.push('!assets/scss/settings/**');
        //zips.push('!assets/scss/tools/**');
        //zips.push('!assets/scss/utilities/**');
        //zips.push('!assets/scss/vendor/**');
        zips.push('!templates/components/**');
        zips.push('!templates/layout/**');
        zips.push('!config.json');
        zips.push('assets/js/bundle.js');

        archive.file(Path.join(themePath, 'config-trial.json'), {name: 'config.json'});
    }
